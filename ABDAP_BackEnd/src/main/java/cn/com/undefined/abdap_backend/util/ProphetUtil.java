...
public class ProphetUtil {
    ...
    public static class ProphetResult {
        ...
        // Getters
        public double[] getHistoricalData() { return historicalData; }
        public double[] getFittedValues() { return fittedValues; }
        public double[] getForecastValues() { return forecastValues; }
        public double[] getTrendComponent() { return trendComponent; }
        public double[] getSeasonalComponent() { return seasonalComponent; }
        public double[] getResiduals() { return residuals; }
        public double getMAPE() { return mape; }
        public int getForecastStartIndex() { return forecastStartIndex; }
